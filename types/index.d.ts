...
export declare abstract class State {
  ...
  */
   ...
   */
  abstract onEnter( event:StateEvent, preState:State ):Promise<any>;

  /**
   * @desc: leave the state. 即将进入下一状态, 故无法调用StateMechine.process_event触发状态切换.
   */
  abstract onLeave( event:StateEvent, nextState:State ):Promise<void>;
   ...
   */
  abstract onProcess( event:StateEvent, nextState:State ):Promise<{transition:boolean, ret?:any}>;
}
...
export declare class StateMechine {
  ...
  */
   ...
   */
  process_event(event: StateEvent): Promise<any>;
}